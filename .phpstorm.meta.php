...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\auth()->user(), map([
        '' => \Modules\Access\Models\User::class,
    ]));
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/yousef-shwawra/Theta-projects/Training/rbac_lab/public/storage' => 'string',
...
'access.name','access.actions','access.resources','app.name','app.env',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/yousef-shwawra/Theta-projects/Training/rbac_lab/public/storage','logging.default',
...
'mail.markdown.paths','mail.markdown.extensions','modules.namespace','modules.vapor_maintenance_mode','modules.stubs.enabled',
...
'modules.paths.generator.class.path','modules.paths.generator.class.generate','modules.paths.generator.command.path','modules.paths.generator.command.generate','modules.paths.generator.command_replacements.path',
'modules.paths.generator.command_replacements.generate','modules.paths.generator.component-class.path','modules.paths.generator.component-class.generate','modules.paths.generator.emails.path','modules.paths.generator.emails.generate',
...
'modules.paths.generator.inertia.path','modules.paths.generator.inertia.generate','modules.paths.generator.inertia-components.path','modules.paths.generator.inertia-components.generate','modules.paths.generator.routes.path',
...
'modules.register.files','modules.activators.file.class','modules.activators.file.statuses-file','modules.activator','modules.inertia.frontend',
...
'logout','api.access.index','api.access.store','api.access.show','api.access.update',
'api.access.destroy','access.index','access.create','access.store','access.show',
'access.edit','access.update','access.destroy','api.agents.index','api.agents.store',
'api.agents.show','api.agents.update','api.agents.destroy','agents.index','agents.create',
'agents.store','agents.show','agents.edit','agents.update','agents.destroy',
'storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'access::components.layouts.master','access::index','agents::components.layouts.master','agents::index','auth.confirm-password',
